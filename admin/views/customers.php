<div class="wrap">
    <div class="dans-wrapper">
        ...
        <div class="dans-navbar">
            <ul>
                <li>
                    <a href="/wp-admin/admin.php?page=notifications" class="nav-tab nav-tab-active">Customers</a>
                </li>
                <li>
                    <a href="/wp-admin/admin.php?page=notifications&tab=products" class="nav-tab">Products</a>
                </li>
            </ul>
        </div>
                        ...
                        <div class="dans-panel__content">
                            <div class="dans-row">
                                <div class="dans-input-text dans-full-width">
                                    <label for="token">
                                        <strong>Enter the customer's name</strong>
                                    </label>
                                    <input type="text" id="__customer" class="dans-regular-text" name="customer" value="" required="" placeholder="Ex. Ricardo dos Santos">
                                    <button id="__dans_submit_customer" type="button" class="dans-button dans-button-submit">
                                        Save Customer
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="dans-list">
                                ...
                                ?>
                                        <div class="dans-list__item">
                                            ...
                                            <button class="dans-button dans-button--danger dans-button-remove-customer" data-id="<?php echo $customer['id']; ?>">Delete</button>
                                        </div>
                                    <?php
                                    }
                                } else {
